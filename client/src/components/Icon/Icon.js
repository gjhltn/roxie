...
export const ICON_TYPE = {
	LETTERS: "M2 18l2.083-5M12 18l-2.083-5m-5.834 0L7 6l2.917 7m-5.834 0h5.834M18 10a4 4 0 100 8 4 4 0 100-8zm4 0v8",
	PLUS: "M20 12L4 12M12 4L12 20",
	BIN:"M19 6H5m9-1h-4m-4 5v10c0 .667.333 1 1 1h10c.667 0 1-.333 1-1V10",
	TRASH: "M19 6L5 6M14 5L10 5M6 10L6 20C6 20.6666667 6.33333333 21 7 21 7.66666667 21 11 21 17 21 17.6666667 21 18 20.6666667 18 20 18 19.3333333 18 16 18 10",
	NOTE: "M13,17 L7,21 L7,17 L3,17 L3,4 L21,4 L21,17 L13,17 Z",
	BIBLIOG: "M12 6s-2-2-4-2-5 2-5 2v14s3-2 5-2 4 2 4 2c1.333-1.333 2.667-2 4-2 1.333 0 3 .667 5 2V6c-2-1.333-3.667-2-5-2-1.333 0-2.667.667-4 2z",
	...
	DRILLDOWN:
		'M13.5 9l3 3-3 3m-6-3H15 M16.5 12H15 M12 2a10 10 0 100 20 10 10 0 100-20z',
	CONTROLS:
	...
	PIN:
		'M12 8a1 1 0 1 0 0 2 1 1 0 1 0 0-2z M12,21 C16,16.8 18,12.8 18,9 C18,5.6862915 15.3137085,3 12,3 C8.6862915,3 6,5.6862915 6,9 C6,12.8 8,16.8 12,21 Z',
	STAR: 'M12 17.844l-5.817 3.058 1.111-6.477-4.706-4.587 6.504-.945L12 3l2.908 5.893 6.504.945-4.706 4.587 1.111 6.477z',
	WARN:
		'M12 10v3m0 3v-1m.9-10.5l8.3 14c.3.5.1 1.1-.4 1.4-.2.1-.4.1-.5.1H3.7c-.6 0-1-.4-1-1 0-.2 0-.4.1-.5l8.3-14c.3-.5.9-.7 1.4-.4.2.1.3.2.4.4z',
	OK: 'M4 13l5 5L20 7',
	GEAR:
