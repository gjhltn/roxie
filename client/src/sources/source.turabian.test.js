...
describe('Turabian books', () => {
	it('1A notes', () => {
		expect(note(eg.turabian1a)).toEqual("Angela Duckworth, _Grit: The Power of Passion and Perseverance_ (New York: Scribner, 2016), XX.")
	})
	it('1A bibliography', () => {
		expect(bibliography(eg.turabian1a)).toEqual("Duckworth, Angela. _Grit: The Power of Passion and Perseverance_. New York: Scribner, 2016.")
	})
	it('2A notes', () => {
		expect(note(eg.turabian2a)).toEqual("Susanne Y. P. Choi and Yinni Peng, _Masculine Promise: Migration, Family, and Gender in China_ (Oakland: University of California Press, 2016), XX.")
	})
	/*
	...
	*/
	...
	it('3A notes', () => {
		expect(note(eg.turabian3a)).toEqual("Jane Austen, _Mansfield Park: An Annotated Edition_, ed. Deidre Shauna Lynch (Cambridge, MA: Belknap Press of Harvard University Press, 2016), XX.")
	})
	it('3a bibliography', () => {
		expect(bibliography(eg.turabian3a)).toEqual("Austen, Jane. _Mansfield Park: An Annotated Edition_. Edited by Deidre Shauna Lynch. Cambridge, MA: Belknap Press of Harvard University Press, 2016.")
	})
})
